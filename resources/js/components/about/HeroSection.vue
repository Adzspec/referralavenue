<template>
<!--    <section class="w-full bg-white py-12 overflow-x-hidden">-->
<!--        <div-->
<!--            class="w-full mx-auto flex flex-col md:flex-row items-center px-4 sm:px-6 lg:px-8"-->
<!--        >-->
...
<!--            <div class="w-full md:w-1/2 min-w-0 mt-10 md:mt-0 flex justify-center">-->
<!--                <svg-->
<!--                    xmlns="http://www.w3.org/2000/svg"-->
<!--                    id="f9c5e9d6-e0c2-49fb-9e36-725fc7f10ee6"-->
<!--                    data-name="Layer 1"-->
<!--                    width="809.67538"-->
<!--                    height="462.57748"-->
...
<!--        </div>-->
<!--    </section>-->
    <section class="ra-hero" aria-label="Hero">
        <div class="faint"></div>

        <div class="ra-container">
            <!-- Left -->
            <div>
                <span class="ra-badge">Built by affiliates</span>
                <h1 class="ra-title">
                    Launch, Manage, and <span class="grow">Grow</span><br/>
                    Your Affiliate Business—All in One Place
                </h1>
                <p class="ra-sub">We provide everything you need to build and run a fully branded, high-performing affiliate site—without developers or complex integrations.</p>
                <div class="ra-ctas">
                    <a href="#features" class="btn-primary">Explore Key Features</a>
                    <a href="#contact" class="btn-ghost">Talk to Sales</a>
                </div>
                <dl class="ra-stats">
                    <div class="stat"><dt>Affiliate Partners</dt><dd>150+</dd></div>
                    <div class="stat"><dt>Affiliate Deals</dt><dd>56+</dd></div>
                    <div class="stat"><dt>Publisher Partnerships</dt><dd>500+</dd></div>
                </dl>
            </div>

            <!-- Right -->
            <div class="ra-illustration">
                <div class="ra-card">
                    <div class="ra-card-inner">
                        <svg viewBox="0 0 24 24" fill="none">
                            <path d="M4 7h16M4 12h16M4 17h10" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                        <p>Your affiliate hub, beautifully organized.</p>
                    </div>
                </div>
            </div>
        </div>
...
:root{
    ...
    --brand-900: #123675;
    --dark: #0b1220;
    --soft-shadow: 0 10px 30px -12px rgba(0,0,0,0.2);
    --glow-shadow: 0 8px 24px rgba(42,130,255,0.45);
    --muted: #64748b;
}
.ra-hero { position:relative; overflow:hidden; padding:4rem 1rem; background:#fff; }
.ra-hero .faint { position:absolute; inset:0; z-index:0; opacity:.12; background:linear-gradient(135deg,var(--brand-500),var(--brand-400) 45%,var(--brand-300)); }
.ra-container { position:relative; z-index:1; max-width:1120px; margin:0 auto; display:grid; grid-template-columns:1fr; gap:2.5rem; align-items:center; }
@media(min-width:1024px){ .ra-container{ grid-template-columns:1fr 1fr; } }
.ra-badge { display:inline-block; padding:.4rem .75rem; border-radius:999px; background:var(--brand-100); color:var(--brand-700); font-weight:600; font-size:.875rem; }
.ra-title { margin-top:1rem; font-weight:800; line-height:1.05; font-size:clamp(1.75rem,4vw,3rem); color:var(--dark); }
.ra-title .grow { background:linear-gradient(90deg,var(--brand-500),var(--brand-400)); -webkit-background-clip:text; background-clip:text; color:transparent; }
.ra-sub { margin-top:1rem; color:var(--muted); max-width:44ch; font-size:1rem; }
.ra-ctas { margin-top:1.25rem; display:flex; gap:.75rem; flex-wrap:wrap; }
.btn-primary { background:var(--brand-600); color:#fff; padding:.75rem 1.25rem; border-radius:999px; text-decoration:none; box-shadow:var(--soft-shadow); }
.btn-primary:hover{ background:var(--brand-700); }
.btn-ghost { padding:.75rem 1.25rem; border-radius:999px; border:1px solid #e6e9ef; background:#fff; color:#111827; text-decoration:none; }
.ra-stats { margin-top:1.5rem; display:grid; grid-template-columns:repeat(3,minmax(0,1fr)); gap:.75rem; max-width:420px; }
.stat { background:#fff; padding:1rem; border-radius:12px; border:1px solid #f1f5f9; box-shadow:0 10px 30px -12px rgba(0,0,0,0.05); }
.stat dt { font-size:.75rem; color:var(--muted); }
.stat dd { font-size:1.125rem; font-weight:700; margin-top:.25rem; }
.ra-illustration { display:flex; align-items:center; justify-content:center; }
.ra-card { width:100%; max-width:520px; border-radius:1.25rem; padding:1rem; background:rgba(255,255,255,0.72); border:1px solid rgba(255,255,255,0.65); box-shadow:var(--soft-shadow); }
.ra-card-inner { border-radius:20px; padding:3rem; text-align:center; color:#fff; background:linear-gradient(135deg,var(--brand-500),var(--brand-400)); }
.ra-card svg { width:120px; height:120px; margin:0 auto; filter:drop-shadow(var(--glow-shadow)); }
.ra-card p { margin-top:1rem; font-weight:600; }
</style>
