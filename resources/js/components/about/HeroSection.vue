    ...
    <section class="w-full bg-white py-12 overflow-x-hidden">
        ...
        >
            ...
            <div class="w-full md:w-1/2 min-w-0 text-center md:text-left">
                ...
                <h2
                    class="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-800 mt-2"
                >
                    Committed to the <br class="hidden sm:inline" />
                    Future
                </h2>
                <p class="mt-4 text-gray-500 text-base">
                    We are <span class="text-blue-600 font-semibold">Monst</span>, a
                    Creative Design Social Marketing
                </p>
